...
Book.create("title" => "Americanah  Chimamanda", "author" => "Ngozi Adichie", "price" => 20)
...
Review.delete_all
Review.create("title" => "Orphan Train", "rating" => 5, "review" => "Riveting!", "book_id" => ot.id)
Review.create("title" => "Orphan Train", "rating" => 2, "review" => "About as dull as you can get.", "book_id" => ss.id)
Review.create("title" => "Orphan Train", "rating" => 3, "review" => "Not bad.", "book_id" => ta.id)
...
puts "There are #{Book.count} books and #{Review.count} Reviews."
